            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <AnimationContainer animation="fadeUp" delay={0.8} className="lg:col-span-12">
                    <div className="relative overflow-hidden">
                        ...
                        {/* Messaging Channel cards - Bento Grid Row 1 */}
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <AnimationContainer animation="fadeUp" delay={0.9}>
                                <div className="group relative bg-surface-container-lowest/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center gap-3 hover:border-green-500/50 hover:bg-surface-container-lowest/60 transition-all duration-500 cursor-pointer">
                                    ...
                                    <div className="relative z-10">
                                        <div className="w-14 h-14 rounded-2xl bg-surface-container flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300 overflow-hidden">
                        ...
                        {/* AI Cards - Bento Grid Row 2 (Bigger cards) */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            {/* Emma AI - The Brain Card */}
                            <AnimationContainer animation="fadeUp" delay={1.3}>
                                <div className="group relative bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-xl border border-primary/30 rounded-2xl p-8 flex flex-row items-center justify-center gap-6 hover:border-secondary/50 hover:from-primary/20 hover:to-secondary/20 transition-all duration-500 cursor-pointer">
                                    <div className="relative z-10">
                            ...
                            {/* RevRa AI - Agentic AI Card */}
                            <AnimationContainer animation="fadeUp" delay={1.4}>
                                <div className="group relative bg-gradient-to-br from-secondary/10 to-primary/10 backdrop-blur-xl border border-secondary/30 rounded-2xl p-8 flex flex-row items-center justify-center gap-6 hover:border-primary/50 hover:from-secondary/20 hover:to-primary/20 transition-all duration-500 cursor-pointer">
                                    <div className="relative z-10">

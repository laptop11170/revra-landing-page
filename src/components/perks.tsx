...
const AIEverywhereCard = () => {
    return (
        <div className="flex flex-col items-start gap-4 p-6 rounded-2xl bg-surface-container-lowest/40 backdrop-blur-xl border border-white/10 hover:border-primary/30 transition-all duration-500 group relative overflow-hidden">
            {/* Background effect */}
            ...
            <div className="flex flex-col gap-3 relative z-10 w-full">
                ...
                {/* AI Command Terminal Visualization */}
                <div className="mt-2">
...
const AllInOneCard = () => {
    ...
    return (
        <div className="flex flex-col items-start gap-4 p-6 rounded-2xl bg-surface-container-lowest/40 backdrop-blur-xl border border-white/10 hover:border-secondary/30 transition-all duration-500 group relative overflow-hidden">
            {/* Background effect */}
                        ...
                        <div className="grid grid-cols-6 gap-1">
                            {tools.map((tool, i) => (
                                <div key={i} className="relative group/tooltip">
                                    <div className={cn(
                                        "flex flex-col items-center justify-center p-1.5 rounded-md bg-surface-container/50 border transition-all duration-300",
                                        tool.status === 'active'
                                        ...
                                        <div className={cn(
                                            ...
                                            tool.status === 'active' ? "bg-green-500" : "bg-white/30"
                                        )} />
                                    </div>

                                    {/* Tooltip */}
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-1.5 py-0.5 bg-surface-container rounded text-[8px] font-mono text-muted-foreground whitespace-nowrap opacity-0 group-hover/tooltip:opacity-100 transition-opacity pointer-events-none z-10">
                                        {tool.name}
                                    </div>
                                </div>
                            ))}
            ...
            <div className="flex flex-col gap-3 relative z-10 w-full">
                ...
                <div className="mt-2">
                    <div className="bg-surface/80 rounded-lg border border-white/10 overflow-hidden">
                        ...
                        <div className="px-3 py-2 border-t border-white/5 bg-surface-container/30">
